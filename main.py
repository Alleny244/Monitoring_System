...
def head_estimator():
    print("\npress q to exit head position estimator\n")   
...
x=1
while(x):
    print("\nPress 1 for head position esimation\n")
    print("Press 2 to track eyeballs\n")
    print("Press 3 to  check if the candidate opens his/her mouth \n")
    print("Press 4 for counting persons and detecting mobile phones\n")
    print("\npress q to exit monitoring modes\n")  
